...
<head>
    ...
    <link href="https://sowrite.cc/wp-content/themes/Adams-Child/style.css?<?php echo THEME_DB_VERSION;?>" type="text/css" rel="stylesheet">
...
<header class="header">
    ...
    <section class="infos">
        ...
        <?php } else { $placard = get_theme_mod('biji_setting_placard');?>
            ...
            <div class="fixed-menus"></div>
            <div class="placard">
                <?php echo $placard == '' ? '名不显时心不朽，再挑灯火看文章。' : $placard;?>
            </div>
        <?php } ?>
        </div>
    </section>
